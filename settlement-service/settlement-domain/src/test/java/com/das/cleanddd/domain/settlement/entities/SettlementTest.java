...
class SettlementTest {
    ...
    class Creation {
        ...
        void shouldCreateOpenSettlement() throws BusinessValidationException {
            Settlement s = Settlement.create("Monthly settlement", SETTLEMENT_DATE, msrId);

            assertNotNull(s.settlementId());
            assertEquals("Monthly settlement", s.description());
            assertEquals(SETTLEMENT_DATE, s.settlementDate());
        ...
        void shouldStripDescription() throws BusinessValidationException {
            Settlement s = new Settlement(null, "  trimmed  ", SETTLEMENT_DATE,
        ...
        void shouldThrowWhenDescriptionNull() {
            assertThrows(BusinessValidationException.class,
                    () -> Settlement.create(null, SETTLEMENT_DATE, msrId));
        }
        ...
        void shouldThrowWhenDescriptionBlank() {
            assertThrows(BusinessValidationException.class,
                    () -> Settlement.create("   ", SETTLEMENT_DATE, msrId));
        }
        ...
        void shouldThrowWhenDateNull() {
            assertThrows(BusinessValidationException.class,
                    () -> Settlement.create("desc", null, msrId));
        }
        ...
        void shouldThrowWhenMsrIdNull() {
            assertThrows(BusinessValidationException.class,
                    () -> Settlement.create("desc", SETTLEMENT_DATE, null));
        }
        ...
        void shouldDefaultStatusToOpen() throws BusinessValidationException {
            Settlement s = new Settlement(null, "desc", SETTLEMENT_DATE, null, null, msrId);
            assertEquals(Settlement.SettlementStatus.OPEN, s.status());
        }
    }
    ...
    class InvoiceManagement {
        ...
        void shouldAddInvoiceToOpenSettlement() throws BusinessValidationException {
            Settlement s = Settlement.create("desc", SETTLEMENT_DATE, msrId);
            Invoice added = s.addInvoice(invNumber, VALID_ISSUE_DATE, VALID_DUE_DATE, new BigDecimal("500.00"));
        ...
        void shouldThrowOnDuplicateInvoiceNumber() throws BusinessValidationException {
            Settlement s = Settlement.create("desc", SETTLEMENT_DATE, msrId);
            s.addInvoice(invNumber, VALID_ISSUE_DATE, null, BigDecimal.ZERO);
        ...
        void shouldThrowWhenAddingToClosedSettlement() throws BusinessValidationException {
            Settlement closed = Settlement.create("desc", SETTLEMENT_DATE, msrId).close();
            assertThrows(BusinessValidationException.class,
                    () -> closed.addInvoice(invNumber, VALID_ISSUE_DATE, null, BigDecimal.ZERO));
        }
        ...
        void shouldRemoveInvoice() throws BusinessValidationException {
            Settlement s = Settlement.create("desc", SETTLEMENT_DATE, msrId);
            Invoice added = s.addInvoice(invNumber, VALID_ISSUE_DATE, null, BigDecimal.ZERO);
        ...
        void shouldThrowWhenRemovingFromClosedSettlement() throws BusinessValidationException {
            Settlement open   = Settlement.create("desc", SETTLEMENT_DATE, msrId);
            Invoice added     = open.addInvoice(invNumber, VALID_ISSUE_DATE, null, BigDecimal.ZERO);
    ...
    class TotalAmount {
        ...
        void shouldSumInvoiceAmounts() throws BusinessValidationException {
            Settlement s = Settlement.create("desc", SETTLEMENT_DATE, msrId);
            s.addInvoice(new InvoiceNumber("A000100000001"), VALID_ISSUE_DATE, null, new BigDecimal("300.00"));
            s.addInvoice(new InvoiceNumber("A000100000002"), VALID_ISSUE_DATE, null, new BigDecimal("200.50"));
    ...
    class CloseSettlement {
        ...
        void closeShouldPreserveInvoices() throws BusinessValidationException {
            Settlement open = Settlement.create("desc", SETTLEMENT_DATE, msrId);
            open.addInvoice(invNumber, VALID_ISSUE_DATE, null, new BigDecimal("100.00"));
            Settlement closed = open.close();
