 ...
 * Calls the msr-service REST API via the Eureka-registered service name,
...
public class HttpMedicalSalesRepRepository implements IMedicalSalesRepRepository {
    ...
    private static final String BASE_URL = "http://medical-sales-rep-service";

    private final RestTemplate restTemplate;

    public HttpMedicalSalesRepRepository(RestTemplate loadBalancedRestTemplate) {
