...
/**
 * Integration tests for {@link SQLMedicalSalesRepRepository}.
 *
 ...
 */
@DataJpaTest
@Import(SQLMedicalSalesRepRepository.class)
class SQLMedicalSalesRepRepositoryTest {

    @Autowired
    private SQLMedicalSalesRepRepository repository;
